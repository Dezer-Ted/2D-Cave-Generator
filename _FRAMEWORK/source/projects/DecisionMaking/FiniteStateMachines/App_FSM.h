...
private:
	...
	float* m_pElapsedSearchTime = nullptr;
	...
	//--States--
	PatrolState* m_pPatrol = nullptr;
	ChaseState* m_pChase = nullptr;
	SearchState* m_pSearch = nullptr;
	//--Transitions--
	...
	//--FSM--
	FiniteStateMachine* m_pStateMachine = nullptr;
