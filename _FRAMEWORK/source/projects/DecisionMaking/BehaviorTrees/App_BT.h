...
private:
	...
	//Datamembers
	// --AI--
	Elite::Blackboard* m_pGuardBoard{ nullptr };
	Elite::BehaviorTree* m_pBehaviorTree{ nullptr };
	std::vector<Elite::IBehavior*> m_PatrolSelector;
	std::vector<Elite::IBehavior*> m_PatrollPartialSequence;
	std::vector<Elite::IBehavior*> m_ChaseSequence;
